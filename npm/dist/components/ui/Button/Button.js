...
var buttonStyles = (0, class_variance_authority_1.cva)("rounded-md cursor-pointer py-2 px-4 font-sm transition duration-300 ease-in-out", {
    variants: {
        size: {
        ...
        color: {
            primary: "bg-[#FFFFFF] text-[#000000] border-2 border-[#000000] hover:bg-[#e0e0e0] ",
