...
var Select = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "relative ".concat(className) },
        react_1.default.createElement("select", { className: "block appearance-none w-full bg-white border border-gray-300 hover:border-gray-400 px-4 py-2 pr-8 rounded-md shadow leading-tight focus:outline-none focus:shadow-outline" },
        ...
        react_1.default.createElement("div", { className: "absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none" },
            react_1.default.createElement("svg", { className: "w-4 h-4 text-gray-400", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor" },
