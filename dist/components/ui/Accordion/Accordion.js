...
var accordionStyles = (0, class_variance_authority_1.cva)("divide-y divide-gray-200", {
    variants: {
        size: {
            small: "w-64",
            medium: "w-80",
...
var Accordion = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: accordionStyles({ color: color, textColor: textColor }) }, items.map(function (item, index) { return (react_1.default.createElement("div", { key: index },
        react_1.default.createElement("div", { className: "flex justify-between items-center cursor-pointer p-4 ".concat(accordionStyles({
            ...
            react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: "h-6 w-6 no-underline transition-transform ".concat(activeIndex === index ? "transform rotate-180" : ""), viewBox: "0 0 20 20", fill: "currentColor" },
                react_1.default.createElement("path", { fillRule: "evenodd", d: "M10 12a1 1 0 0 1-.707-.293l-3-3a1 1 0 0 1 1.414-1.414L10 10.586l2.293-2.293a1 1 0 0 1 1.414 1.414l-3 3a1 1 0 0 1-.707.293z", clipRule: "evenodd" }))),
